...
RELEASE_LAST_UPDATED = "2026-07-31 03:05:00"
    ...
    update_manifest = {
        ...
        "sections": {
            "changelog": (
                f"<h4>{version}</h4>"
                "<ul>"
                "<li>Ensured every plugin-owned public shell renders one escaped, non-empty document title independent of active-theme title support.</li>"
