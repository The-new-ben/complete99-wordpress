...
define('COMPLETE99_PLATFORM_VERSION', '1.9.0');
define('COMPLETE99_PLATFORM_DEPLOYMENT_ID', 'c99-wp-1.9.0');
...
class LiveReadModelContracts(unittest.TestCase):
    ...
    def test_health_exposes_only_the_stored_read_model_digest_and_fresh_requires_it(
        ...
        $health = static function($model = null) {
            ...
            $GLOBALS['c99_persisted_options']['complete99_platform_version'] = serialize('1.9.0');
            $GLOBALS['c99_persisted_options']['complete99_last_deployment_id'] = serialize('c99-wp-1.9.0');
    ...
    def test_transport_time_and_shape_tampering_fail_closed_before_storage(self) -> None:
        ...
        $c99_persisted_options['complete99_platform_version'] = serialize('1.9.0');
