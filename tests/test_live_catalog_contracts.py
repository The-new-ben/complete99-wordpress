...
"""
    ...
    def test_release_version_is_exact_1_10_0(self) -> None:
        source = MAIN.read_text(encoding="utf-8")
        self.assertRegex(source, r"(?m)^ \* Version:\s+1\.10\.0$")
        self.assertIn("define( 'COMPLETE99_PLATFORM_VERSION', '1.10.0' );", source)
        self.assertIn("define( 'COMPLETE99_PLATFORM_DEPLOYMENT_ID', 'c99-wp-1.10.0' );", source)
