...
$entities[] = $c99_entity(
	array(
		...
		'summary' => $c99_text( 'קומה קוג׳י הוא אורז מאודה שעליו גדל Aspergillus oryzae בתהליך מבוקר. הוא משמש בין היתר במיסו, סאקה ומירין. אין לבלבל אותו עם קוג׳י לשויו, שבדרך כלל מבוסס על מצע סויה וחיטה ודורש ישות נפרדת. זן התרבית, הטמפרטורה, הלחות והמצע חייבים להיות מתועדים.', 'Kome koji is steamed rice cultivated with Aspergillus oryzae under controlled conditions. It is used in products including miso, sake and mirin. It must not be conflated with shoyu koji, which typically uses a soybean and wheat substrate and requires a separate entity. Culture strain, temperature, humidity and substrate must be documented.' ),
		...
		'facts' => array(
			...
			$c99_fact( 'fact-koji-process-node', 'structural', 'בגרף, קוג׳י מקשר חומר גלם, תרבית, אנזים, תהליך ומוצר מותסס.', 'In the graph, koji connects substrate, culture, enzyme, process and fermented product.', 'editorial_inference', 'entity', array( 'maff-fermented-foods' ) ),
		),
		'profiles' => $c99_profiles( array(
			...
			'economic' => $c99_profile( 'pending_evidence', 'ערך יושווה לפי מצע, משקל, חיות תרבית, קירור ותפוקה.', 'Value will be compared by substrate, weight, culture viability, cold chain and yield.' ),
			'structural' => $c99_profile( 'source_backed', 'ישות צומת בין מדע למוצר מותסס.', 'A junction entity between science and fermented products.', array( 'fact-koji-process-node' ) ),
		) ),
		...
		'relations' => array( $c99_relation( 'requires', 'reaction-koji-enzymatic-hydrolysis', 'האנזימים מניעים פירוק עמילנים וחלבונים.', 'The enzymes drive starch and protein hydrolysis.' ) ),
...
$entities[] = $c99_entity( array(
	...
	'facts' => array(
		...
		$c99_fact( 'fact-koshihikari-lot-boundary', 'structural', 'מקור, קציר, טחינה, לחות, אחסון ו-COA נשמרים ברמת SKU ואצווה.', 'Origin, harvest, milling, moisture, storage and COA are stored at SKU and lot level.', 'editorial_inference', 'entity', array( 'koshihikari-genome-2018' ) ),
	),
	'profiles' => $c99_profiles( array(
		...
		'economic' => $c99_profile( 'pending_evidence', 'השוואת מחיר תדרוש אותו קציר, אזור, הסמכה, טחינה ומשקל.', 'Price comparison requires the same harvest, region, certification, milling and weight.' ),
		'structural' => $c99_profile( 'source_backed', 'הישות מפרידה בין זן, מוצר ואצווה.', 'The entity separates cultivar, product and lot.', array( 'fact-koshihikari-lot-boundary' ) ),
	) ),
	...
	'relations' => array( $c99_relation( 'used_in', 'preparation-sushi-shari', 'הזן הוא אפשרות חומר גלם לשארי, בכפוף למוצר ולמתכון בפועל.', 'The cultivar is a possible shari ingredient subject to the actual product and recipe.', true, array( 'koshihikari-genome-2018' ), 'peer_reviewed_context' ) ),
	'commerce_state' => 'supplier_onboarding',
	'cross_sell_ids' => array( 'equipment-hangiri', 'ingredient-kioke-shoyu' ),
