...
define( 'COMPLETE99_PLATFORM_VERSION', '1.22.1' );
define( 'COMPLETE99_PLATFORM_DEPLOYMENT_ID', 'c99-wp-1.22.1' );
...
require_once COMPLETE99_PLATFORM_DIR . 'includes/class-complete99-consumer-media-rights.php';
require_once COMPLETE99_PLATFORM_DIR . 'includes/class-complete99-ops.php';
require_once COMPLETE99_PLATFORM_DIR . 'includes/class-complete99-campaigns.php';
...
require_once COMPLETE99_PLATFORM_DIR . 'includes/class-complete99-cross-domain-bindings.php';
...
require_once COMPLETE99_PLATFORM_DIR . 'includes/class-complete99-entity-studio.php';
