...
## Current 1.3.12 catalog boundary

Release 1.3.12 supersedes the earlier evaluation-only pantry state described in
...
No Complete99 worker role is installed or assigned by release 1.3.12. The private
